...
class _TrashScreenState extends State<TrashScreen> {
  ...
  void initState() {
    super.initState();
    _trashVM = ServiceLocator.trashViewModel;
                  ...
                  slivers: [
                    SliverGrid(
                      ...
                      delegate: SliverChildBuilderDelegate((context, index) {
                        final mediaAsset = _trashVM.trashedMediaAssets[index];
                        final thumbnailProvider = _trashVM.thumbnailProviderFor(
                          mediaAsset.assetId,
                        );
                        ...
                        final selectionOverlay = GestureDetector(
                          ...
                          onLongPress: () => _toggleSelect(mediaAsset.assetId),
                          onTap: () {
                            if (isInSelectionMode) {
                              _toggleSelect(mediaAsset.assetId);
                            } else {
                              // context.push(
