...
abstract class ITrashRepository {
  ...
  ///
  /// The underlying implementation is dependent on the platform.
  ///
  /// For Android, it will simply delete the trash entry from ObjectBox, so that the media asset will be visible again in the main collection.
