...
// class AiInferenceWorkerRepository extends IBackgroundWorkerRepository {
...
//   @override
//   Future<TextEncodingResult> encodeText(String text) {
//     final String taskId = _generateTaskId();
//     final Completer<TextEncodingResult> completer = Completer();

//     _taskResolvers[taskId] = completer;
//     workerSendPort?.send(TextEncodingCommand(taskId: taskId, query: text));

//     return completer.future;
//   }

//   @override
//   Future<IndexingResult> indexImage(MediaAsset media) {
//     final String taskId = _generateTaskId();
...
//         params[MethodParams.textEncoderExtractedPath];
//     final String imageEncoderExtractedPath =
//         params[MethodParams.imageEncoderExtractedPath];
//     final String bpeVocabExtractedPath =
//         params[MethodParams.bpeVocabExtractedPath];
//     final String bpeMergesExtractedPath =
//         params[MethodParams.bpeMergesExtractedPath];
...
//       } else if (message is TextEncodingResult) {
//         _resolveTask(message.taskId, message);
...
//           final result = TextEncodingResult.success(message.taskId, embedding);
//           workerConfig.mainSendPort.send(result);
//         } catch (e, _) {
//           workerConfig.mainSendPort.send(
//             TextEncodingResult.failure(message.taskId, 'Error: $e'),
//           );
//         }
//       }
//     });
...
//   await worker.init({
//     MethodParams.textEncoderExtractedPath: textEncoderFilePath,
//     MethodParams.imageEncoderExtractedPath: imageEncoderFilePath,
//     MethodParams.bpeVocabExtractedPath: bpeVocabFilePath,
//     MethodParams.bpeMergesExtractedPath: bpeMergesFilePath,
//   });
